...
* TechInfoDepot: this data is licensed under [CC-BY-SA 3.0][CC-BY-SA 3.0]
  ...
  under the same license as the [data in Wireshark][wireshark-data] (GPL-2.0-or-later)
* WikiDevi: this data is licensed under [CC-BY-SA 3.0][CC-BY-SA 3.0]
  except files in the `overlays/` directory which are licensed under different
  licenses: FCC id files are licensed under [CC0][CC0], network OUI files are
  under the same license as the [data in Wireshark][wireshark-data] (GPL-2.0-or-later)
* OpenWrt: this data is licensed under [CC-BY-SA 4.0][CC-BY-SA 4.0]
  except files in the `overlays/` directory which are licensed under different
  licenses: FCC id files are licensed under [CC0][CC0], network OUI files are
  under the same license as the [data in Wireshark][wireshark-data] (GPL-2.0-or-later)
...
[wireshark-data]:https://gitlab.com/wireshark/wireshark/-/blob/master/epan/manuf-data.c
