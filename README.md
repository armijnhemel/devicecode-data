...
* WikiDevi: this data is licensed under [CC-BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/)
  except files in the `overlays/` directory which are licensed under different
  licenses: FCC id files are licensed under [CC0][CC0], network OUI files are
  under the same license as Wireshark (GPL-2.0)
* OpenWrt: this data is licensed under [CC-BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/)
  except files in the `overlays/` directory which are licensed under different
  licenses: FCC id files are licensed under [CC0][CC0], network OUI files are
  under the same license as Wireshark (GPL-2.0)
