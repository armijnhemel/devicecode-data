====== Techdata: WAVLINK WL-WN532N2 REV.F ======
~~HIDEPAGE~~
~~NOTRANS~~
~~NOTOC~~
/*********************************************************
...
Brand                                       : WAVLINK # ===>  Mandatory  <===
Model                                       : WL-WN532N2 # ===>  Mandatory  <===
Versions                                    : REV.F # List versions comma separated: v1, v1.1, v1.5, v2, v2.5
...
Subtarget                                   : ¿ # see https://openwrt.org/docs/techref/targets
Package architecture_pkg-arch               :  # https://openwrt.org/docs/techref/instructionset
Bootloader_bootloader                       : U-Boot # https://openwrt.org/docs/techref/bootloader
CPU                                         : MediaTek MT7628N # Main CPU/SoC, e.g. Atheros AR9331; Broadcom BCM6361
CPU Cores_numcores_                         : 1 # Number of CPU cores
CPU MHz                                     : 575 # pure number without 'MHz'
Flash MB_mbflashs                           : 32 # CTRL+click for multiselect
RAM MB_mbram                                : 256 # .
...
WLAN 5.0GHz_wlan50                          : ¿ # WLAN 5GHz capabilities
WLAN Comments_                              :  # MIMO and other WIFI information
WLAN driver_wlan-drivers                    : unknown # CTRL+click for multiselect; see https://openwrt.org/docs/techref/driver.wlan
...
OWrt Forum Topic URL_urls                   :  # forum.openwrt.org/viewtopic.php?id=xxxxx
Forum search_search-forums                  : WL-WN532N2 # query to search for latest forum postings related to this device, e.g. DIR-505
Git search_search-gits                      : WL-WN532N2 # query to search for latest git commits related to this device, e.g. DIR-505
...
Firmware OpenWrt snapshot Upgrade URL_urls  :  # https://downloads.openwrt.org/snapshots/targets/...sysupgrade.bin
Installation method(s)_method-installations : U-Boot TFTP + serial recovery # CTRL+click for multiselect
...
Recovery method(s)_method-recoverys         : U-Boot TFTP + serial recovery # CTRL+click for multiselect
